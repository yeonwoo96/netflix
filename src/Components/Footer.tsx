...
const Footer = () => {
  return (
    <FooterWrap>
      <SnsWrap>
        <Link target="blank" to="https://www.instagram.com/kite_shin/">
          <Svg
        ...
        <Link
          target="blank"
          to="https://github.com/yeonwoo96/netflix/tree/master/src"
        >
          <Svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
        ...
        <Link target="blank" to="https://velog.io/@kitecow">
          <Svg
            width="192"
            height="192"
            viewBox="0 0 192 192"
